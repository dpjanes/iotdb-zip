 ...
 */
const initialize_load = (_self, done) => {
    const self = _.d.clone.shallow(_self);
 ...
 */
const initialize_open = (_self, done) => {
    const self = _.d.clone.shallow(_self);
    ...
    _.promise.make(self)
        ...
        .then(_.promise.denodeify(initialize_load))
 ...
 */
const initialize_open_p = _path => _.promise.denodeify((_self, done) => {
    const self = _.d.clone.shallow(_self);
    ...
    _.promise.make(self)
        ...
        .then(_.promise.denodeify(initialize_open))
        .then(_.promise.done(done, self, "zip"))
        .catch(done)
})
...
exports.initialize.load = _.promise.denodeify(initialize_load);
exports.initialize.open = _.promise.denodeify(initialize_open);
